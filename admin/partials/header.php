...
<header class="header header-nav-menu header-nav-links">
    <div class="logo-container">
        <a href="../" class="logo">
            ...
            <img src="assets/img/logo-modern.png" class="logo-image" width="90" height="24" alt="Porto Admin" /><img
                src="assets/img/logo-default.png" class="logo-image-mobile" width="90" height="41" alt="Porto Admin" />
        </a>
    ...
    <div class="header-right">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
            <a class="dropdown-item" href="#"><img src="assets/img/blank.gif" class="flag flag-us" alt="English" />
                English</a>
            <a class="dropdown-item" href="#"><img src="assets/img/blank.gif" class="flag flag-es" alt="English" />
                Español</a>
            <a class="dropdown-item" href="#"><img src="assets/img/blank.gif" class="flag flag-fr" alt="English" />
                Française</a>
        </div>
