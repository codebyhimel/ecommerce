...
if (isset($_REQUEST['submit'])) {
    $sql = 'UPDATE `slider` SET `subTitle`=:subTitle,`title`=:title,`detailes`=:details,`btnOneText`=:btnOneText,`btnOneUrl`=:btnOneUrl,`btnTwoText`=:btnTwoTxt,`btnTwoUrl`=:btnTwoUrl,`align`=:align,`image`=:image,`isActive`=:isActive WHERE `id` = :id';
    $stmt = $db->dbHandler->prepare($sql);
    ...
    <div class="inner-wrapper">
        ...
        <section role="main" class="content-body content-body-modern">
            <header class="page-header page-header-left-inline-breadcrumb">
                <h2 class="font-weight-bold text-6">Edit Slider</h2>
                        ...
                        <div class="card-body p-5">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="details" class="form-control" id="details" placeholder="details" value="<?= $data['detailes']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="btnTwoTxt" class="form-control" id="btnTwoTxt" placeholder="Explore" value="<?= $data['btnTwoText']; ?>">
                                </div>
                                <div class="form-group">
