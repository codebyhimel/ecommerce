...
if (isset($_GET['slider_id'])) {
    ...
    if ($slider) {
        ...
        $deleteSql = "DELETE FROM slider WHERE id = :id";
...
<div class="inner-wrapper">
    ...
    <section role="main" class="content-body content-body-modern mt-5">
        <header class="page-header page-header-left-inline-breadcrumb">
            <h2 class="font-weight-bold text-6">Slider List </h2>
                            ...
                            <div class="datatable-header">
                                <div class="row align-items-center mb-3">
                                    <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                        <a href="/shop/admin/createSlider.php" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4">+ Add Slider</a>
                                    </div>
                                        ...
                                        <?php foreach ($data as $item) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="sliderIndex.php?slider_id=<?= $item['id']; ?>"
