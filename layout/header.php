        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-6 col-md-12">
                <ul class="header-top-menu">
                    <li><a href="admin/dashboard.php"><i class='bx bxs-user'></i> My Account</a></li>
                    <li><a href="wishlist.php" data-bs-toggle="modal" data-bs-target="#shoppingWishlistModal"><i
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a href="#" class="nav-link">Blog <i
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a href="blog-6.html" class="nav-link">Masonry (3 in Row)</a>
                                </li>
